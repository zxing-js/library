...
export default class UPCAReader extends UPCEANReader {
  ...
  public decodeRow(rowNumber: number, row: BitArray, arg3: Int32Array | Map<DecodeHintType, any>, arg4?: Map<DecodeHintType, any>): Result {
    ...
    return this.decodeRowOverload(rowNumber, row, startGuardRange, hints);
  }

  protected decodeRowOverload(rowNumber: number, row: BitArray, startGuardRange: Int32Array, hints?: Map<DecodeHintType, any>): Result {
