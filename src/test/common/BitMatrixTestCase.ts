...
describe("BitMatrixTestCase", () => {
  ...
  it("testEnclosing", () => {
    ...
    assert.strictEqual(AssertUtils.int32ArraysAreEqual(Int32Array.from([ 1, 1, 1, 1 ]), matrix.getEnclosingRectangle()), true)
    matrix.setRegion(1, 1, 3, 2)
    assert.strictEqual(AssertUtils.int32ArraysAreEqual(Int32Array.from([ 1, 1, 3, 2 ]), matrix.getEnclosingRectangle()), true)
    matrix.setRegion(0, 0, 5, 5)
    assert.strictEqual(AssertUtils.int32ArraysAreEqual(Int32Array.from([ 0, 0, 5, 5 ]), matrix.getEnclosingRectangle()), true)
  })
  ...
  it("testOnBit", () => {
    ...
    matrix.setRegion(1, 1, 1, 1)
    assert.strictEqual(AssertUtils.int32ArraysAreEqual(Int32Array.from([ 1, 1 ]), matrix.getTopLeftOnBit()), true)
    assert.strictEqual(AssertUtils.int32ArraysAreEqual(Int32Array.from([ 1, 1 ]), matrix.getBottomRightOnBit()), true)
    matrix.setRegion(1, 1, 3, 2)
    assert.strictEqual(AssertUtils.int32ArraysAreEqual(Int32Array.from([ 1, 1 ]), matrix.getTopLeftOnBit()), true)
    assert.strictEqual(AssertUtils.int32ArraysAreEqual(Int32Array.from([ 3, 2 ]), matrix.getBottomRightOnBit()), true)
    matrix.setRegion(0, 0, 5, 5)
    assert.strictEqual(AssertUtils.int32ArraysAreEqual(Int32Array.from([ 0, 0 ]), matrix.getTopLeftOnBit()), true)
    assert.strictEqual(AssertUtils.int32ArraysAreEqual(Int32Array.from([ 4, 4 ]), matrix.getBottomRightOnBit()), true)
  })
