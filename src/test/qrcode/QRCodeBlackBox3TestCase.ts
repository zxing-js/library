...
import MultiFormatReader from './../../lib/MultiFormatReader'
import AbstractBlackBoxTestCase from './../common/AbstractBlackBoxTestCase'

/**
 * @author dswitkin@google.com (Daniel Switkin)
 */
export default class QRCodeBlackBox3TestCase extends AbstractBlackBoxTestCase {
...
describe("QRCodeBlackBox3TestCase", () => {
  it("testBlackBox", (done) => {
    const test = new QRCodeBlackBox3TestCase()
    test.testBlackBox(() => {
      done()
    })
  })
