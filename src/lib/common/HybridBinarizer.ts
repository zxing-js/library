...
export default class HybridBinarizer extends GlobalHistogramBinarizer {
   ...
   */
  private static calculateThresholdForBlock(luminances: Uint8Array,
                                                 subWidth: number/*int*/,
   ...
   */
  private static thresholdBlock(luminances: Uint8Array,
                                    xoffset: number/*int*/,
                                    yoffset: number/*int*/,
   ...
   */
  private static calculateBlackPoints(luminances: Uint8Array,
                                        subWidth: number/*int*/,
                                        subHeight: number/*int*/,
                                        width: number/*int*/,
